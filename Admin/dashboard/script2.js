...
document.querySelector("#save2").addEventListener('click', () => {
    ...
    localStorage.setItem('second-color', allColorInp[1].value);

})

document.querySelector("#save3").addEventListener('click', () => {

    localStorage.setItem('third-color', allColorInp[2].value);

})

document.querySelector("#save4").addEventListener('click', () => {

    localStorage.setItem('fourth-color', allColorInp[3].value);

})

document.querySelector("#save5").addEventListener('click', () => {

    localStorage.setItem('fifth-color', allColorInp[4].value);

})

document.querySelector("#save6").addEventListener('click', () => {

    localStorage.setItem('sixth-color', allColorInp[5].value);
